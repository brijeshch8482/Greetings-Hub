...
import 'package:invitation_card_maker/card_customization_screen/card_customization_behavior.dart';
...
class _GalleryScreenState extends State<GalleryScreen> with GalleryBehavior {
  void requestStoragePermission() async {
    ...
    for(var element in statuses.values) {
      ...
      else if(element.isDenied){

        Navigator.pop(context);
      }
      else if(element.isRestricted){
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text('access restricted!'),
        ));
      }
      else if(element.isLimited){
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
