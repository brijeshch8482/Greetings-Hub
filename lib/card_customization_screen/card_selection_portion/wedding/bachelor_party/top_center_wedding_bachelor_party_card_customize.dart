...
class TopCenterWeddingBachelorPartyCardCustomize extends StatelessWidget {
  ...
  const TopCenterWeddingBachelorPartyCardCustomize({
    Key? key,
  ...
  Widget build(BuildContext context) {
    containerIndexAnimationNumber = [0,2,2,1,0];
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[0],maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: '$formalInvitationHeaderTextPartOne$formalInvitationHeaderTextPartTwo'.toUpperCase(), animationTextNumber: containerIndexAnimationNumber[0], myContainerIndex: 0));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: descriptionText, animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: nameText, animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[4], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: '$dateTimeText at ${pickedTime!.format(context).toLowerCase()}\nin ${reformatAddress(address: textFieldDataMap[hintTextList[1]]!)}', animationTextNumber: containerIndexAnimationNumber[4], myContainerIndex: 4));
              }),
