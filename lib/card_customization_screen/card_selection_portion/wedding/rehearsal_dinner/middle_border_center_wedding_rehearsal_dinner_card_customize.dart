...
class MiddleBorderCenterWeddingRehearsalDinnerCardCustomize extends StatelessWidget {
  ...
  final String followAtLocationText;
  final String addressText;

  const MiddleBorderCenterWeddingRehearsalDinnerCardCustomize({
    Key? key,
    ...
    required this.followAtLocationText,
    required this.addressText}) : super(key: key);
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: nameText1, animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: nameText2, animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[4], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: '$dateTimeText\nat ${pickedTime!.format(context).toLowerCase()} in ${reformatAddress(address: addressText)}', animationTextNumber: containerIndexAnimationNumber[4], myContainerIndex: 4));
            }),
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[5], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: followAtLocationText, animationTextNumber: containerIndexAnimationNumber[5], myContainerIndex: 5));
            }),
