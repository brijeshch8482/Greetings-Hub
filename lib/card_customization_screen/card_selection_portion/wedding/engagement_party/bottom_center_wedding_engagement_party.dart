...
class BottomCenterWeddingEngagementParty extends StatelessWidget {
  const BottomCenterWeddingEngagementParty({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'You are invited ';
    withYourFamilyTextFormat = 'with your family\n';
    formalInvitationHeaderTextPartTwo = 'to\nthe engagement party';
