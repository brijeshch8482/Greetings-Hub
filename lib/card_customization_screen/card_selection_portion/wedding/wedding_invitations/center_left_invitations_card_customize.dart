...
class CenterLeftInvitationsCardCustomize extends StatelessWidget {
  const CenterLeftInvitationsCardCustomize({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'Please Join us to\n';
    formalInvitationHeaderTextPartTwo = 'celebrating the\nholly union of';
        ...
        children: [
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[1], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[0]]!.replaceFirst(' ', '\n'), animationTextNumber: containerIndexAnimationNumber[1], myContainerIndex: 1));
              }),
          ...
          Selector<CardCustomizationScreenChangeNotifier, bool>(
              ...
              builder: (context, value, child) {
                ...
                return Visibility(visible: animatedTextContainerVisibilityList[3], maintainState: true, maintainSize: true, maintainAnimation: true, child: invitationCardSingleTextContainer(text: textFieldDataMap[hintTextList[1]]!.replaceFirst(' ', '\n'), animationTextNumber: containerIndexAnimationNumber[3], myContainerIndex: 3));
              }),
