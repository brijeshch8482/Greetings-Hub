...
class TopCenterInvitationsCardCustomize extends StatelessWidget {
  const TopCenterInvitationsCardCustomize({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartTwo = 'to attend\nthe wedding ceremony of';
