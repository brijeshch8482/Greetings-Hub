...
class CenterInvitationsCardCustomize extends StatelessWidget {
  const CenterInvitationsCardCustomize({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    formalInvitationHeaderTextPartOne = 'you are warmly invited\n';
    withYourFamilyTextFormat = 'with your family';
    formalInvitationHeaderTextPartTwo = 'to attend the wedding of';
