...
class CenterWeddingSaveTheDateCardCustomize extends StatelessWidget {
  ...
  const CenterWeddingSaveTheDateCardCustomize({
    Key? key,
  ...
  Widget build(BuildContext context) {
    containerIndexAnimationNumber = [0,2,1,1,2,0];
      ...
      children: [
        ...
        Selector<CardCustomizationScreenChangeNotifier, bool>(
            ...
            builder: (context, value, child) {
              ...
              return Visibility(visible: animatedTextContainerVisibilityList[2], maintainState: true, maintainSize: true, maintainAnimation: true,child: invitationCardSingleTextContainer(text: '$nameText1\n&', animationTextNumber: containerIndexAnimationNumber[2], myContainerIndex: 2));
            }),
