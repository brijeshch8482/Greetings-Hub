...
///
class MyTypewriterAnimatedText extends MyAnimatedText {
  ...
  Widget animatedBuilder(BuildContext context, Widget? child) {
    ...
    int textLen = textCharacters.length;
    int typewriterValue = (_typewriterText.value.clamp(0, 1) *
...
class MyTypewriterAnimatedTextKit extends MyAnimatedTextKit {
  MyTypewriterAnimatedTextKit({
    Key? key,
  ...
  static List<MyAnimatedText> _animatedTexts(
      ...
      text
          .map((_) => MyTypewriterAnimatedText(
        _,
        textAlign: textAlign,
        textStyle: textStyle,
        speed: speed,
