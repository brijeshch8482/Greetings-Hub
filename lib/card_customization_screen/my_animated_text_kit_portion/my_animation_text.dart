...
import '../../gallery_screen/gallery_behavior.dart';
    ...
    if (state == AnimationStatus.completed) {
      ...
      if(widget.animationControllerIndex < (myAnimatedTextKitControllerMap.length-2) && isPreviewEnable) {
        ...
        if(isInAnimationToVideo) {
          ...
          //image invitation
          currentImageTitle = '${mainCategoryTitleMap[mainCategoryTitle]}${subCategoryTitleMap[mainCategoryTitle]![subCategoryTitle]}-${DateTime.now().toString().replaceAll(' ', '').replaceAll(':', '').replaceAll('-', '').replaceAll('.', '')}.png';
          ...
          currentVideoTitle = '${mainCategoryTitleMap[mainCategoryTitle]}${subCategoryTitleMap[mainCategoryTitle]![subCategoryTitle]}-${DateTime.now().toString().replaceAll(' ', '').replaceAll(':', '').replaceAll('-', '').replaceAll('.', '')}.mp4';
          ...
          if(animationProgressStatusChangeNotifier!.gifInvitation) {
            currentGifTitle = '${mainCategoryTitleMap[mainCategoryTitle]}${subCategoryTitleMap[mainCategoryTitle]![subCategoryTitle]}-${DateTime.now().toString().replaceAll(' ', '').replaceAll(':', '').replaceAll('-', '').replaceAll('.', '')}.gif';
