...
class CardCustomizationScreen extends StatefulWidget {
  ...
  CardCustomizationScreen({Key? key, required this.subCategoryCardData})
      : super(key: key);

  dynamic subCategoryCardData;
...
class _CardCustomizationScreenState extends State<CardCustomizationScreen>
  ...
  void initState() {
    ...
    _storedCardData = widget.subCategoryCardData;

    isAnimationCompleted = false;
    // print("completeCategoryName: ${completeCategoryName.toString()}");
    // getSubCategoryImageWithoutText(
    //     completeCategory: completeCategoryName, index: widget.cardCategoryIndexProvider.cardindex, title: mainCategoryTitle);

    cardCustomizationScreenChangeNotifier =
        Provider.of<CardCustomizationScreenChangeNotifier>(context,
            listen: false);

    cardCustomizationScreenChangeNotifier.initSelectorControllerList();

    // initCardCustomizationDataModelList(
    //   cardName: widget.subCategoryCardData.subCategoryImageIndex,
    // );

    cardColumn = cardMainCategorySelection(
      subCategoryCardData: widget.subCategoryCardData, context: context
    );
  ...
  void startAnimatedText() {
    ...
    cardCustomizationScreenChangeNotifier
            .cardCustomizationSelectorControllerList[0] =
        !cardCustomizationScreenChangeNotifier
            .cardCustomizationSelectorControllerList[0];
    ...
    return WillPopScope(
      onWillPop: () {
        ...
        for (int i = 0; i < cardCustomizationDataModelList.length; i++) {
          animatedTextContainerVisibilityList[i] = false;
          cardCustomizationDataModelList[i].customizeContainerBorderColor =
              Colors.transparent;
          cardCustomizationScreenChangeNotifier
        ...
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              Flexible(
                ...
                child: GestureDetector(
                    onTap: () {
                      ...
                      for (int i = 0;
                          i < cardCustomizationDataModelList.length;
                          i++) {
              ...
              Flexible(
                  flex: 2,
                  child: Consumer<CardCustomizationScreenChangeNotifier>(
                    builder: (BuildContext context,
                        cardCustomizationScreenChangeNotifier, Widget? child) {
                      return GestureDetector(
                        onTap: () {
                          isAnimationCompleted = false;
                          cardCustomizationScreenChangeNotifier.buttonEnabled =
                              true;
                          for (int i = 0;
                              i < myAnimatedTextKitControllerMap.length - 1;
                              i++) {
                      ...
                      return GestureDetector(
                        onTap: () async {
                          if (!(cardCustomizationScreenChangeNotifier
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(
                                    content: Text('Please first Preview')));
                          } else if (!isAnimationCompleted) {
                            ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Please wait')));
                          } else {
                            //Taking screenshot of the card
                            ...
                            Navigator.pushNamedAndRemoveUntil(
                                context,
                                AnimationToVideoScreen.ROUTE_NAME,
                                arguments: CardToImage(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(15),
                              color: !cardCustomizationScreenChangeNotifier
                                      .buttonEnabled
                ...
                children: [
                  ListView(
                    children: [
                      AspectRatio(
                        ...
                        child: RepaintBoundary(
                          ...
                          child: FutureBuilder<String?>(
                              future: getSubCategoryImageWithoutText(
                                  completeCategory: completeCategoryName, index: _storedCardData.subCategoryImageIndex, title: mainCategoryTitle),
                              builder: (context, snapshot) {
                                ...
                                if (imageUrl == null) {
                                  print("cardCategoryIndexProvider: ${_storedCardData.subCategoryImageIndex}");
                      ...
                      Selector<CardCustomizationScreenChangeNotifier, double?>(
                        shouldRebuild: (previous, next) => previous != next,
                        selector:
                            (context, cardCustomizationScreenChangeNotifier) =>
                                cardCustomizationScreenChangeNotifier
