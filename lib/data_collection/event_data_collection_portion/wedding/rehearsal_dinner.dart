...
class RehearsalDinner extends StatefulWidget {
  const RehearsalDinner({Key? key}) : super(key: key);

  @override
  _RehearsalDinnerState createState() => _RehearsalDinnerState();
}

class _RehearsalDinnerState extends State<RehearsalDinner> {
