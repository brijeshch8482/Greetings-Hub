...
class BachelorParty extends StatefulWidget {
  const BachelorParty({Key? key}) : super(key: key);

  @override
  _BachelorPartyState createState() => _BachelorPartyState();
}

class _BachelorPartyState extends State<BachelorParty> {
