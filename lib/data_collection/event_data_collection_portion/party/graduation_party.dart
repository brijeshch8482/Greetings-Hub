...
class GraduationParty extends StatefulWidget {
  const GraduationParty({Key? key}) : super(key: key);

  @override
  _GraduationPartyState createState() => _GraduationPartyState();
}

class _GraduationPartyState extends State<GraduationParty> {
