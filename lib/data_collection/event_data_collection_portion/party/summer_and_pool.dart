...
class SummerAndPool extends StatefulWidget {
  const SummerAndPool({Key? key}) : super(key: key);

  @override
  _SummerAndPoolState createState() => _SummerAndPoolState();
}

class _SummerAndPoolState extends State<SummerAndPool> {
  EdgeInsetsGeometry margin = EdgeInsets.only(bottom: 10);
